...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `36.8µs` | `161.4µs` |
| [Day 2](./src/bin/02.rs) | `31.6µs` | `29.2µs` |
| [Day 3](./src/bin/03.rs) | `152.4µs` | `254.1µs` |
| [Day 4](./src/bin/04.rs) | `126.4µs` | `119.7µs` |
| [Day 5](./src/bin/05.rs) | `22.0µs` | `1.5s` |
